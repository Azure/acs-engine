...
**NOTE:** DCOS deployments will fail with Azure xplat CLI version > 10.0.  Use [Azure xplat cli 0.10.0](https://github.com/Azure/azure-xplat-cli/releases/tag/v0.10.0-May2016).  Eta for Azure cli fix is Dec 2016.
