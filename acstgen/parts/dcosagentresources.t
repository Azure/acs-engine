    ...
    },
    {
      ...
      "name": "[concat(variables('storageAccountPrefixes')[mod(add(copyIndex(),mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('storageAccountPrefixes')[div(add(copyIndex(),mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('{{.Name}}AccountName'))]", 
      "properties": {
...
{{if IsPublic .Ports}}
    ...
    },{{end}}
    {
      "apiVersion": "[variables('apiVersionDefault')]", 
      "dependsOn": [
        "[concat('Microsoft.Storage/storageAccounts/',variables('storageAccountPrefixes')[mod(add(0,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('storageAccountPrefixes')[div(add(0,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('{{.Name}}AccountName'))]",
        "[concat('Microsoft.Storage/storageAccounts/',variables('storageAccountPrefixes')[mod(add(1,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('storageAccountPrefixes')[div(add(1,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('{{.Name}}AccountName'))]", 
        "[concat('Microsoft.Storage/storageAccounts/',variables('storageAccountPrefixes')[mod(add(2,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('storageAccountPrefixes')[div(add(2,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('{{.Name}}AccountName'))]", 
        "[concat('Microsoft.Storage/storageAccounts/',variables('storageAccountPrefixes')[mod(add(3,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('storageAccountPrefixes')[div(add(3,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('{{.Name}}AccountName'))]", 
        "[concat('Microsoft.Storage/storageAccounts/',variables('storageAccountPrefixes')[mod(add(4,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('storageAccountPrefixes')[div(add(4,mul(variables('{{.Name}}Index'),variables('agentStorageAccountsCount'))),variables('storageAccountPrefixesCount'))],variables('{{.Name}}AccountName'))]",  
