...
The following illustrates a template with 2 extensions: first-extension and second-extension.
...
``` javascript
{
  ...
  "properties": {
    ...
    "linuxProfile": { ...},
    "extensionsProfile": [
        { "name": "first-extension", "version": "v1", "extensionParameters": "parameters" },
        { "name": "second-extension", "version": "v1", "extensionParameters": "parameters" }
    ],
    ...
    }
}
...
- [sysdig-cloud-k8s] (../extensions/sysdig-cloud-k8s/README.md)
