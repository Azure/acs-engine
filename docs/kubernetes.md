...
The current implementation of Calico uses Flanal as the network overlay via CNI. The combination of Calico with Flanal is known as [Canal](https://github.com/projectcalico/canal/). Long-term, Flanal will be replaced with [Azure CNI](https://github.com/Azure/azure-container-networking/blob/master/docs/cni.md) as the provider for networking in this configuration.
