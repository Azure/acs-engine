...
|Name|Required|Description|
|---|---|---|
|kubernetesImageBase|no|This specifies the base URL (everything preceding the actual image filename) of image of kubernetes to use for the cluster, e.g., `gcrio.azureedge.net/google_containers/`.|
