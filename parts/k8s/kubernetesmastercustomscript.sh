...
# ETCD_PEER_CERTIFICATE ETCD_PEER_PRIVATE_KEY ADMINUSER
...
ETCD_PEER_0_PRIVATE_KEY_PATH="/etc/kubernetes/certs/etcdpeer0.key"
touch "${ETCD_PEER_0_PRIVATE_KEY_PATH}"
chmod 0600 "${ETCD_PEER_0_PRIVATE_KEY_PATH}"
chown root:root "${ETCD_PEER_0_PRIVATE_KEY_PATH}"
echo "${ETCD_PEER_0_PRIVATE_KEY}" | base64 --decode > "${ETCD_PEER_0_PRIVATE_KEY_PATH}"

ETCD_PEER_1_PRIVATE_KEY_PATH="/etc/kubernetes/certs/etcdpeer1.key"
touch "${ETCD_PEER_1_PRIVATE_KEY_PATH}"
chmod 0600 "${ETCD_PEER_1_PRIVATE_KEY_PATH}"
chown root:root "${ETCD_PEER_1_PRIVATE_KEY_PATH}"
echo "${ETCD_PEER_1_PRIVATE_KEY}" | base64 --decode > "${ETCD_PEER_1_PRIVATE_KEY_PATH}"

ETCD_PEER_2_PRIVATE_KEY_PATH="/etc/kubernetes/certs/etcdpeer2.key"
touch "${ETCD_PEER_2_PRIVATE_KEY_PATH}"
chmod 0600 "${ETCD_PEER_2_PRIVATE_KEY_PATH}"
chown root:root "${ETCD_PEER_2_PRIVATE_KEY_PATH}"
echo "${ETCD_PEER_2_PRIVATE_KEY}" | base64 --decode > "${ETCD_PEER_2_PRIVATE_KEY_PATH}"
...
ETCD_PEER_0_CERTIFICATE_PATH="/etc/kubernetes/certs/etcdpeer0.crt"
touch "${ETCD_PEER_0_CERTIFICATE_PATH}"
chmod 0644 "${ETCD_PEER_0_CERTIFICATE_PATH}"
chown root:root "${ETCD_PEER_0_CERTIFICATE_PATH}"
echo "${ETCD_PEER_0_CERTIFICATE}" | base64 --decode > "${ETCD_PEER_0_CERTIFICATE_PATH}"

ETCD_PEER_1_CERTIFICATE_PATH="/etc/kubernetes/certs/etcdpeer1.crt"
touch "${ETCD_PEER_1_CERTIFICATE_PATH}"
chmod 0644 "${ETCD_PEER_1_CERTIFICATE_PATH}"
chown root:root "${ETCD_PEER_1_CERTIFICATE_PATH}"
echo "${ETCD_PEER_1_CERTIFICATE}" | base64 --decode > "${ETCD_PEER_1_CERTIFICATE_PATH}"

ETCD_PEER_2_CERTIFICATE_PATH="/etc/kubernetes/certs/etcdpeer2.crt"
touch "${ETCD_PEER_2_CERTIFICATE_PATH}"
chmod 0644 "${ETCD_PEER_2_CERTIFICATE_PATH}"
chown root:root "${ETCD_PEER_2_CERTIFICATE_PATH}"
