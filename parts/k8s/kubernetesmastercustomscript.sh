...
echo APISERVER_PUBLIC_KEY=$APISERVER_PUBLIC_KEY
echo SUBSCRIPTION_ID=$SUBSCRIPTION_ID
echo RESOURCE_GROUP=$RESOURCE_GROUP
echo LOCATION=$LOCATION
echo SUBNET=$SUBNET
echo NETWORK_SECURITY_GROUP=$NETWORK_SECURITY_GROUP
echo VIRTUAL_NETWORK=$VIRTUAL_NETWORK
echo VIRTUAL_NETWORK_RESOURCE_GROUP=$VIRTUAL_NETWORK_RESOURCE_GROUP
echo ROUTE_TABLE=$ROUTE_TABLE
echo PRIMARY_AVAILABILITY_SET=$PRIMARY_AVAILABILITY_SET
...
echo KUBELET_PRIVATE_KEY=$KUBELET_PRIVATE_KEY
echo TARGET_ENVIRONMENT=$TARGET_ENVIRONMENT
echo NETWORK_POLICY=$NETWORK_POLICY
echo FQDNSuffix=$FQDNSuffix
echo VNET_CNI_PLUGINS_URL=$VNET_CNI_PLUGINS_URL
echo CNI_PLUGINS_URL=$CNI_PLUGINS_URL
echo MAX_PODS=$MAX_PODS
echo CLOUDPROVIDER_BACKOFF=$CLOUDPROVIDER_BACKOFF
echo CLOUDPROVIDER_BACKOFF_RETRIES=$CLOUDPROVIDER_BACKOFF_RETRIES
echo CLOUDPROVIDER_BACKOFF_EXPONENT=$CLOUDPROVIDER_BACKOFF_EXPONENT
echo CLOUDPROVIDER_BACKOFF_DURATION=$CLOUDPROVIDER_BACKOFF_DURATION
echo CLOUDPROVIDER_BACKOFF_JITTER=$CLOUDPROVIDER_BACKOFF_JITTER
echo CLOUDPROVIDER_RATELIMIT=$CLOUDPROVIDER_RATELIMIT
echo CLOUDPROVIDER_RATELIMIT_QPS=$CLOUDPROVIDER_RATELIMIT_QPS
echo CLOUDPROVIDER_RATELIMIT_BUCKET=$CLOUDPROVIDER_RATELIMIT_BUCKET
echo USE_MANAGED_IDENTITY_EXTENSION=$USE_MANAGED_IDENTITY_EXTENSION
echo USE_INSTANCE_METADATA=$USE_INSTANCE_METADATA
