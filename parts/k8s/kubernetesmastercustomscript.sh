...
# ETCD_PEER_CERTIFICATE ETCD_PEER_PRIVATE_KEY ADMINUSER MASTER_OFFSET
...
echo "${ETCD_PEER_PRIVATE_KEY[${MASTER_OFFSET}]}" | base64 --decode > "${ETCD_PEER_PRIVATE_KEY_PATH}"
...
echo "${ETCD_PEER_CERTIFICATE[${MASTER_OFFSET}]}" | base64 --decode > "${ETCD_PEER_CERTIFICATE_PATH}"
