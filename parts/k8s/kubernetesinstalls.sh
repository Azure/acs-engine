...
function installDeps() {
    ...
    apt-add-repository -y "deb http://archive.ubuntu.com/ubuntu/ xenial-proposed restricted main multiverse universe" || exit $ERR_APT_UPDATE_TIMEOUT
    apt_get_update || exit $ERR_APT_UPDATE_TIMEOUT
    apt_get_upgrade || exit $ERR_APT_UPDATE_TIMEOUT
    apt_get_dist_upgrade || exit $ERR_APT_UPDATE_TIMEOUT
    apt_get_install 30 1 600 linux-image-4.15.0-1030-azure || exit $ERR_APT_UPDATE_TIMEOUT
