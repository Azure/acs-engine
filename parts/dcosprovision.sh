...
BOOTSTRAP_DOWNLOAD_URL=https://dcosio.azureedge.net/dcos/testing/bootstrap/${BOOTSTRAP_ID}.bootstrap.tar.xz
BOOTSTRAP_DOWNLOAD_URL_2=https://az837203.vo.msecnd.net/dcos/testing/bootstrap/${BOOTSTRAP_ID}.bootstrap.tar.xz
...
case $DCOS_ENVIRONMENT in
    ...
    AzureChinaCloud)
        BOOTSTRAP_DOWNLOAD_URL=http://acsengine.blob.core.chinacloudapi.cn/dcos/${BOOTSTRAP_ID}.bootstrap.tar.xz
        BOOTSTRAP_DOWNLOAD_URL_2=http://acsengine.blob.core.chinacloudapi.cn/dcos/${BOOTSTRAP_ID}.bootstrap.tar.xz
...
curl -fLsSv --retry 20 -Y 100000 -y 60 -o $MESOSDIR/bootstrap.tar.xz $BOOTSTRAP_DOWNLOAD_URL &
curl -fLsSv --retry 20 -Y 100000 -y 60 -o $MESOSDIR/bootstrap.tar.xz $BOOTSTRAP_DOWNLOAD_URL_2 &
