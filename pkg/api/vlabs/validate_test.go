...
func Test_KubernetesConfig_Validate(t *testing.T) {
	...
	for _, k8sVersion := range []OrchestratorVersion{Kubernetes160, Kubernetes162, Kubernetes166, Kubernetes170, Kubernetes171} {
		c := KubernetesConfig{}
	...
	for _, k8sVersion := range []OrchestratorVersion{Kubernetes160, Kubernetes162} {
		c := KubernetesConfig{
