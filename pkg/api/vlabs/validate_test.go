...
func Test_KubernetesConfig_Validate(t *testing.T) {
	...
	for _, k8sVersion := range []string{Kubernetes153, Kubernetes157, Kubernetes160, Kubernetes162, Kubernetes166, Kubernetes168, Kubernetes170, Kubernetes171, Kubernetes172} {
		c := KubernetesConfig{}
	...
	for _, k8sVersion := range []string{Kubernetes166, Kubernetes168, Kubernetes170, Kubernetes171, Kubernetes172} {
		c := KubernetesConfig{
			CloudProviderBackoff:   true,
			CloudProviderRateLimit: true,
		}
