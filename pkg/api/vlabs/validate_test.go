...
func Test_KubernetesConfig_Validate(t *testing.T) {
	...
	for _, k8sVersion := range []string{common.KubernetesVersion1Dot5Dot8, common.KubernetesVersion1Dot6Dot11, common.KubernetesVersion1Dot7Dot7, common.KubernetesVersion1Dot8Dot0} {
		c := KubernetesConfig{}
	...
	for _, k8sVersion := range []string{common.KubernetesVersion1Dot6Dot11, common.KubernetesVersion1Dot7Dot7, common.KubernetesVersion1Dot8Dot0} {
		c := KubernetesConfig{
			CloudProviderBackoff:   true,
			CloudProviderRateLimit: true,
		}
