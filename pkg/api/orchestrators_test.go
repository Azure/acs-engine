...
func TestOrchestratorUpgradeInfo(t *testing.T) {
	...
	orch, e = GetOrchestratorVersionProfile(csOrch)
	Expect(e).To(BeNil())
	// 1.8.6, 1.8.7, 1.8.8, 1.8.9, 1.8.10, 1.9.0, 1.9.1, 1.9.2, 1.9.3, 1.9.4, 1.9.5, 1.9.6
	...
	orch, e = GetOrchestratorVersionProfile(csOrch)
	Expect(e).To(BeNil())
	// 1.10.0-beta.2, 1.10.0-beta.4, 1.10.0-rc.1
	Expect(len(orch.Upgrades)).To(Equal(3))

	// 1.10.0-beta.4 is upgradable to 1.10.x
	csOrch = &OrchestratorProfile{
		OrchestratorType:    Kubernetes,
	...
	csOrch = &OrchestratorProfile{
		OrchestratorType:    Kubernetes,
		OrchestratorVersion: "1.10.0-rc.1",
	}
	orch, e = GetOrchestratorVersionProfile(csOrch)
	Expect(e).To(BeNil())
	...
	Expect(e).To(BeNil())
	Expect(len(list.Properties.Orchestrators)).To(Equal(41))
