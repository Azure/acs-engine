...
var k8sComponentVersions = map[string]map[string]string{
	"1.13": {
		...
		"cluster-proportional-autoscaler":  "cluster-proportional-autoscaler-amd64:1.3.0",
	...
	"1.12": {
		...
		NVIDIADevicePluginAddonName:        "k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "k8s-dns-sidecar-amd64:1.14.10",
		"cluster-proportional-autoscaler":  "cluster-proportional-autoscaler-amd64:1.2.0",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
		"podeviction":                      DefaultKubernetesCtrlMgrPodEvictionTimeout,
		"routeperiod":                      DefaultKubernetesCtrlMgrRouteReconciliationPeriod,
	...
	"1.11": {
		...
		NVIDIADevicePluginAddonName:        "k8s-device-plugin:1.11",
		"k8s-dns-sidecar":                  "k8s-dns-sidecar-amd64:1.14.10",
		"cluster-proportional-autoscaler":  "cluster-proportional-autoscaler-amd64:1.1.2-r2",
		"nodestatusfreq":                   DefaultKubernetesNodeStatusUpdateFrequency,
		"nodegraceperiod":                  DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
		"podeviction":                      DefaultKubernetesCtrlMgrPodEvictionTimeout,
		"routeperiod":                      DefaultKubernetesCtrlMgrRouteReconciliationPeriod,
...
func getK8sVersionComponents(version string, overrides map[string]string) map[string]string {
	...
	case "1.13":
		ret = map[string]string{
			...
			"cluster-proportional-autoscaler":  k8sComponentVersions["1.13"]["cluster-proportional-autoscaler"],
