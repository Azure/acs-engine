...
func convertMasterProfileToVLabs(api *MasterProfile, vlabsProfile *vlabs.MasterProfile) {
	...
	if api.IsClassicProfile() {
		vlabsProfile.ClassicProfile = vlabs.ClassicAgentPoolProfileType(api.ClassicProfile)
	}
}
...
func convertAgentPoolProfileToVLabs(api *AgentPoolProfile, p *vlabs.AgentPoolProfile) {
	...
	p.FQDN = api.FQDN
	if api.IsClassicProfile() {
		p.ClassicProfile = vlabs.ClassicAgentPoolProfileType(api.ClassicProfile)
	}
}
