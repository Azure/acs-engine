...
const (
	// KubernetesVersion1Dot10Beta2 is the string for kubernetes 1.10.0-beta.2
	KubernetesVersion1Dot10Beta2 string = "1.10.0-beta.2"
...
var AllKubernetesSupportedVersions = map[string]bool{
	...
	KubernetesVersion1Dot10Beta2: true,
}
...
var AllKubernetesWindowsSupportedVersions = map[string]bool{
	...
	KubernetesVersion1Dot9Dot2:   true,
	KubernetesVersion1Dot9Dot3:   true,
	KubernetesVersion1Dot10Beta2: false,
}
