...
func Test_GetValidPatchVersion(t *testing.T) {
	...
	version = GetValidPatchVersion(Kubernetes, "1.9.6")
	if version != KubernetesVersion1Dot9Dot6 {
		t.Errorf("It is not Kubernetes version %s", KubernetesVersion1Dot9Dot6)
	}

	version = GetValidPatchVersion(Kubernetes, "1.10.0-rc.1")
	if version != KubernetesVersion1Dot10Dot0RC1 {
		t.Errorf("It is not Kubernetes version %s", KubernetesVersion1Dot10Dot0RC1)
	}
}
...
func TestGetLatestPatchVersion(t *testing.T) {
	...
	if version != KubernetesVersion1Dot8Dot10 {
		t.Errorf("It is not Kubernetes version %s", KubernetesVersion1Dot8Dot10)
	}
...
func Test_RationalizeReleaseAndVersion(t *testing.T) {
	...
	version = RationalizeReleaseAndVersion(Kubernetes, "v1.8", "", false)
	if version != KubernetesVersion1Dot8Dot10 {
		t.Errorf("It is not Kubernetes version %s", KubernetesVersion1Dot8Dot10)
	}
