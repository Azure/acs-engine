...
func TestGetK8sVersionComponents(t *testing.T) {
	...
	expected := map[string]string{
		...
		"cluster-proportional-autoscaler":  k8sComponentVersions["1.12"]["cluster-proportional-autoscaler"],
	...
	expected = map[string]string{
		...
		"cluster-proportional-autoscaler":  k8sComponentVersions["1.11"]["cluster-proportional-autoscaler"],
	...
	expected = map[string]string{
		...
		"cluster-proportional-autoscaler":  k8sComponentVersions["1.10"]["cluster-proportional-autoscaler"],
	...
	expected = map[string]string{
		...
		"cluster-proportional-autoscaler":  k8sComponentVersions["1.9"]["cluster-proportional-autoscaler"],
