package v20180801preview_test

import (
	"github.com/Azure/acs-engine/pkg/api"
	"github.com/Azure/acs-engine/pkg/api/agentPoolOnlyApi/v20180801preview"
...
func TestRegisterHandler(t *testing.T) {
	...
	RunSpecsWithReporters(t, "apiloader", "v20180801preview Suite")
}

var _ = Describe("v20180801preview test suite", func() {
	...
	Context("when networkprofile is nil, enable the addon profile", func() {
		It("should merge fields properly", func() {
			...
			model := v20180801preview.ManagedCluster{
				Name: "myaks",
				Properties: &v20180801preview.Properties{
					DNSPrefix:         "myaks",
					KubernetesVersion: k8sVersions[0],
					AgentPoolProfiles: []*v20180801preview.AgentPoolProfile{
						{
							Name:           "agentpool1",
							Count:          3,
					...
					ServicePrincipalProfile: &v20180801preview.ServicePrincipalProfile{
						ClientID: "clientID",
						Secret:   "clientSecret",
					},
				},
			...
			model2 := v20180801preview.ManagedCluster{
				Properties: &v20180801preview.Properties{
					AddonProfiles: map[string]v20180801preview.AddonProfile{
						"omsagent": {
							Enabled: true,
						},
					},
		...
		It("should merge fields properly", func() {
			...
			model := v20180801preview.ManagedCluster{
				...
				Properties: &v20180801preview.Properties{
					DNSPrefix:         "myaks",
					KubernetesVersion: k8sVersions[0],
					NetworkProfile: &v20180801preview.NetworkProfile{
						NetworkPlugin:    v20180801preview.Azure,
