...
var k8sComponentVersions = map[string]map[string]string{
	"1.11": {
		...
		"container-monitoring": "container-monitoring:v1.0.0",
...
func getK8sVersionComponents(version string, overrides map[string]string) map[string]string {
	...
	case "1.10":
		ret = map[string]string{
			...
			DefaultContainerMonitoringAddonName: k8sComponentVersions["1.10"]["container-monitoring"],
	...
	case "1.6":
		ret = map[string]string{
			...
			DefaultContainerMonitoringAddonName: k8sComponentVersions["1.6"]["container-monitoring"],
