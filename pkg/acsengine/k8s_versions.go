...
const AddonResizerVersionK8s1Dot8AndBelow = "addon-resizer:1.7"
...
var KubeConfigs = map[string]map[string]string{
	common.KubernetesVersion1Dot9Dot3: {
		...
		DefaultDashboardAddonName:     "kubernetes-dashboard-amd64:v1.8.3",
		...
		"addonmanager":              "kube-addon-manager-amd64:v8.6",
	...
	common.KubernetesVersion1Dot9Dot0: {
		...
		DefaultDashboardAddonName:     "kubernetes-dashboard-amd64:v1.8.3",
		"exechealthz":                 "exechealthz-amd64:1.2",
		"addonresizer":                AddonResizerVersionK8s1Dot8AndBelow,
		"heapster":                    "heapster-amd64:v1.5.1",
		DefaultMetricsServerAddonName: "metrics-server-amd64:v0.2.1",
		"dns":                       "k8s-dns-kube-dns-amd64:1.14.8",
		"addonmanager":              "kube-addon-manager-amd64:v8.6",
