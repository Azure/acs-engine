...
const (
	// CNI_PLUGIN_VER specifies version of CNI plugin, mirrored from
	// https://github.com/containernetworking/cni/releases/download/${CNI_PLUGIN_VER}/cni-amd64-${CNI_PLUGIN_VER}.tgz
	// to https://acs-mirror.azureedge.net/cni/
	CNI_PLUGIN_VER = "v0.6.0"
	// AZURE_PLUGIN_VER specifies version of Azure CNI plugin, which has been mirrored from
	// https://github.com/Azure/azure-container-networking/releases/download/${AZURE_PLUGIN_VER}/azure-vnet-cni-linux-amd64-${AZURE_PLUGIN_VER}.tgz
	// to https://acs-mirror.azureedge.net/cni/
	AZURE_PLUGIN_VER = "v0.91"
)
var (
	...
	DefaultKubernetesSpecConfig = KubernetesSpecConfig{
		...
		CNIPluginsDownloadURL:            "https://acs-mirror.azureedge.net/cni/cni-amd64-"+CNI_PLUGIN_VER+".tgz",
		VnetCNILinuxPluginsDownloadURL:   "https://acs-mirror.azureedge.net/cni/azure-vnet-cni-linux-amd64-"+AZURE_PLUGIN_VER+".tgz",
		VnetCNIWindowsPluginsDownloadURL: "https://acs-mirror.azureedge.net/cni/azure-vnet-cni-windows-amd64-"+AZURE_PLUGIN_VER+".zip",
	}
