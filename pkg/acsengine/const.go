...
const (
	...
	// DefaultKubernetsDnsServiceIP specifies the IP address that kube-dns
	// listens on by default. must by in the default Service CIDR range.
	DefaultKubernetsDnsServiceIP = "10.0.0.10"
	// DefaultKubernetsServiceCIDR specifies the IP subnet that kubernetes will
	// create Service IPs within.
	DefaultKubernetsServiceCIDR = "10.0.0.0/16"
