...
const (
	// TODO(colemick): this should be pulled from the Azure Env now... :)
	// this may mean mapping the location to a cloud and then loading from
	// SDK, but it beats duplicating the suffixes here.
