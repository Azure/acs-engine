...
func TestGetK8sVersionComponents(t *testing.T) {
	...
	expected := map[string]string{
		...
		DefaultContainerMonitoringAddonName: k8sComponentVersions["1.11"][DefaultContainerMonitoringAddonName],
	...
	expected = map[string]string{
		...
		DefaultContainerMonitoringAddonName: k8sComponentVersions["1.9"][DefaultContainerMonitoringAddonName],
	...
	expected = map[string]string{
		...
		DefaultContainerMonitoringAddonName: k8sComponentVersions["1.8"][DefaultContainerMonitoringAddonName],
	...
	expected = map[string]string{
		...
		DefaultContainerMonitoringAddonName: k8sComponentVersions["1.7"][DefaultContainerMonitoringAddonName],
