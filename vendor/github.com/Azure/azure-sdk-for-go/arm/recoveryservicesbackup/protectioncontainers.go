...
// fabricName is name of the fabric where the container belongs. containerName
// is name of the container whose details need to be fetched.
...
// Refresh discovers all the containers in the subscription that can be backed
// up to Recovery Services Vault. This is an asynchronous operation. To know
// the status of the operation, call GetRefreshOperationResult API.
//
// vaultName is the name of the recovery services vault. resourceGroupName is
// the name of the resource group where the recovery services vault is present.
// fabricName is fabric name associated the container.
