...
// policyName is backup policy to be created. parameters is resource backup
// policy
...
// Delete deletes specified backup policy from your Recovery Services Vault.
// This is an asynchronous operation. Status of the operation can be fetched
// using GetPolicyOperationResult API.
//
// vaultName is the name of the recovery services vault. resourceGroupName is
// the name of the resource group where the recovery services vault is present.
// policyName is backup policy to be deleted.
...
// Get provides the details of the backup policies associated to Recovery
// Services Vault. This is an asynchronous operation. Status of the operation
// can be fetched using GetPolicyOperationResult API.
//
// vaultName is the name of the recovery services vault. resourceGroupName is
// the name of the resource group where the recovery services vault is present.
// policyName is backup policy information to be fetched.
