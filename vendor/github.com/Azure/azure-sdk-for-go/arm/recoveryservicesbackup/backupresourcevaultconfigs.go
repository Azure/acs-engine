...
// BackupResourceVaultConfigsClient is the client for the
// BackupResourceVaultConfigs methods of the Recoveryservicesbackup service.
type BackupResourceVaultConfigsClient struct {
	ManagementClient
}

// NewBackupResourceVaultConfigsClient creates an instance of the
// BackupResourceVaultConfigsClient client.
...
// NewBackupResourceVaultConfigsClientWithBaseURI creates an instance of the
// BackupResourceVaultConfigsClient client.
...
// vaultName is the name of the recovery services vault. resourceGroupName is
// the name of the resource group where the recovery services vault is present.
// parameters is resource config request
